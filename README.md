...
- **Node.js 26.2.0** - Latest LTS Node.js runtime
- **Yarn Berry 4.15.0** - Modern package management with node_modules
...
- **Node.js**: `>=26.2.0` (Latest LTS)
- **Yarn**: `>=4.15.0` (Berry with node_modules)
...
**Note:** This project includes a `.nvmrc` file that specifies Node.js 26.2.0. If you use nvm, it will automatically use the correct version when you `cd` into the project directory (with nvm auto-use enabled).
