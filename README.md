...
- **Node.js 25.2.1** - Latest LTS Node.js runtime
...
- **Node.js**: `>=25.2.1` (Latest LTS)
- **Yarn**: `>=4.12.0` (Berry with node_modules)
...
**Note:** This project includes a `.nvmrc` file that specifies Node.js 25.2.1. If you use nvm, it will automatically use the correct version when you `cd` into the project directory (with nvm auto-use enabled).
